...
object LibraryDependency {
    ...
    const val DAGGER_HILT = "com.google.dagger:hilt-android:${LibraryVersion.DAGGER}"
    const val DAGGER_HILT_COMPILER = "com.google.dagger:hilt-android-compiler:${LibraryVersion.DAGGER}"
    ...
    const val MDEX = "androidx.multidex:multidex:${LibraryVersion.MDEX}"
}
