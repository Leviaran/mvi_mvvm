package me.randyarba.base_library.base.di
...
class KotlinViewModelProvider private constructor() {
    companion object {
        inline fun <reified T : ViewModel> of(fragment: Fragment, crossinline factory: () -> T) : T {
            ...
            val fmFactory = object: ViewModelProvider.Factory{
                override fun <U : ViewModel?> create(modelClass: Class<U>): U = factory() as U
            }

            return ViewModelProviders.of(fragment, fmFactory)[T::class.java]
        }
        ...
        inline fun <reified T : ViewModel> of(fragmentActivity: FragmentActivity, crossinline factory: () -> T) : T {
            ...
            return ViewModelProviders.of(fragmentActivity, fmFactory)[T::class.java]
        }
